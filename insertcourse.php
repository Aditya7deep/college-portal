        ...
        <form method="post" action="">
            ...
            <div class="form-container color-container">
              <div class="card-header">  <?php
                ...
                if($name!="" && $week!="" && $fees!="")
                    {
                    $q="INSERT INTO `courses`(`name`,`duration`,`fees`) values ('$name','$week','$fees')";
                ...
                <lable>Duration(in week):</lable>
                <input type="text" name="week" class="form-control" placeholder="Enter duration">

                <lable>Fees(in k):</lable>
                <input type="text" name="fees" class="form-control" placeholder="Enter Amount">
